-- =====================================================
-- CONTATIENDA - DATOS DE EJEMPLO SQLITE
-- Datos de prueba para el sistema contable local
-- =====================================================

-- =====================================================
-- USUARIOS DE PRUEBA (SIMPLIFICADOS)
-- =====================================================
INSERT INTO usuarios (cedula, password_hash, ultimo_acceso, estado) VALUES
('12345678', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2024-01-25 16:30:00', 'activo'),
('87654321', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2024-01-25 15:45:00', 'activo'),
('11223344', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2024-01-24 14:20:00', 'activo'),
('55667788', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '2024-01-23 11:15:00', 'activo');
...
(1, 1, 'propietario'),  -- Usuario 12345678 es propietario de Tienda El Éxito
(2, 1, 'contador'),     -- Usuario 87654321 es contador de Tienda El Éxito
(2, 2, 'contador'),     -- Usuario 87654321 también es contador de Distribuidora ABC
(3, 2, 'propietario'),  -- Usuario 11223344 es propietario de Distribuidora ABC
(4, 3, 'propietario'),  -- Usuario 55667788 es propietario de Servicios Contables Pro
(1, 3, 'empleado');     -- Usuario 12345678 también tiene acceso a Servicios Contables Pro
...
-- ACTIVOS
(1, '1', 'ACTIVOS', 'activo', 'deudor', 1, 0, 'activa'),
(1, '11', 'ACTIVO CORRIENTE', 'activo', 'deudor', 2, 0, 'activa'),
(1, '1105', 'CAJA', 'activo', 'deudor', 3, 1, 'activa'),
(1, '1110', 'BANCOS', 'activo', 'deudor', 3, 1, 'activa'),
(1, '1305', 'CLIENTES', 'activo', 'deudor', 3, 1, 'activa'),
(1, '1435', 'INVENTARIOS', 'activo', 'deudor', 3, 1, 'activa'),
(1, '15', 'ACTIVO NO CORRIENTE', 'activo', 'deudor', 2, 0, 'activa'),
(1, '1516', 'MAQUINARIA Y EQUIPO', 'activo', 'deudor', 3, 1, 'activa'),
(1, '1524', 'EQUIPO DE COMPUTACIÓN', 'activo', 'deudor', 3, 1, 'activa'),

-- PASIVOS
(1, '2', 'PASIVOS', 'pasivo', 'acreedor', 1, 0, 'activa'),
(1, '21', 'PASIVO CORRIENTE', 'pasivo', 'acreedor', 2, 0, 'activa'),
(1, '2205', 'PROVEEDORES NACIONALES', 'pasivo', 'acreedor', 3, 1, 'activa'),
(1, '2335', 'IVA PAGADO EN COMPRAS', 'pasivo', 'acreedor', 3, 1, 'activa'),
(1, '25', 'PASIVO NO CORRIENTE', 'pasivo', 'acreedor', 2, 0, 'activa'),

-- PATRIMONIO
(1, '3', 'PATRIMONIO', 'patrimonio', 'acreedor', 1, 0, 'activa'),
(1, '31', 'CAPITAL', 'patrimonio', 'acreedor', 2, 0, 'activa'),
(1, '3115', 'CAPITAL SOCIAL', 'patrimonio', 'acreedor', 3, 1, 'activa'),
(1, '33', 'RESERVAS', 'patrimonio', 'acreedor', 2, 0, 'activa'),
(1, '36', 'SUPERÁVIT', 'patrimonio', 'acreedor', 2, 0, 'activa'),
(1, '3605', 'UTILIDADES DEL EJERCICIO', 'patrimonio', 'acreedor', 3, 1, 'activa'),

-- INGRESOS
(1, '4', 'INGRESOS', 'ingreso', 'acreedor', 1, 0, 'activa'),
(1, '41', 'INGRESOS OPERACIONALES', 'ingreso', 'acreedor', 2, 0, 'activa'),
(1, '4135', 'VENTAS', 'ingreso', 'acreedor', 3, 1, 'activa'),
(1, '4175', 'DEVOLUCIONES EN VENTAS', 'ingreso', 'acreedor', 3, 1, 'activa'),
(1, '4210', 'FINANCIEROS', 'ingreso', 'acreedor', 2, 0, 'activa'),
(1, '421005', 'INTERESES', 'ingreso', 'acreedor', 3, 1, 'activa'),

-- GASTOS
(1, '5', 'GASTOS', 'gasto', 'deudor', 1, 0, 'activa'),
(1, '51', 'GASTOS OPERACIONALES', 'gasto', 'deudor', 2, 0, 'activa'),
(1, '5105', 'GASTOS DE PERSONAL', 'gasto', 'deudor', 3, 1, 'activa'),
(1, '5205', 'GASTOS GENERALES', 'gasto', 'deudor', 3, 1, 'activa'),
(1, '5305', 'GASTOS DE VENTAS', 'gasto', 'deudor', 3, 1, 'activa'),
(1, '5405', 'GASTOS FINANCIEROS', 'gasto', 'deudor', 3, 1, 'activa'),

-- COSTOS
(1, '6', 'COSTOS', 'costo', 'deudor', 1, 0, 'activa'),
(1, '61', 'COSTOS DE VENTAS', 'costo', 'deudor', 2, 0, 'activa'),
(1, '6105', 'COSTO DE VENTAS', 'costo', 'deudor', 3, 1, 'activa');
